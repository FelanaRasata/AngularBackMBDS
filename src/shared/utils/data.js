const userList = [{
    role: 'TEACHER', username: 'btodarini0@smugmug.com', password: '123456789', name: 'Bernadette Todarini'
}, {role: 'TEACHER', username: 'dburnall1@wikia.com', password: '123456789', name: 'Dietrich Burnall'}, {
    role: 'STUDENT', username: 'gmingotti2@arstechnica.com', password: '123456789', name: 'Garner Mingotti'
}, {role: 'STUDENT', username: 'wlindroos3@cnn.com', password: '123456789', name: 'Wren Lindroos'}, {
    role: 'STUDENT', username: 'fgabbott4@tripadvisor.com', password: '123456789', name: 'Federico Gabbott'
}]

var subjectList = [{
    title: 'BMW', image: 'http://dummyimage.com/241x100.png/5fa2dd/ffffff',
}, {
    title: 'Mazda', image: 'http://dummyimage.com/172x100.png/dddddd/000000',
}]
var assignmentList = [{
